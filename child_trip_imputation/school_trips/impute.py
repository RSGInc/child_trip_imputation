...
class ImputeSchoolTrips:
    ...
    def school_trip_imputation(self, Day: DayManagerClass, person_day_trips: pd.DataFrame) -> None:
        person_day_trips
        Day.Person.Household.data
               

    def is_missing_school_trip(self, Day: DayManagerClass, person_day_trips: pd.DataFrame) -> bool:
